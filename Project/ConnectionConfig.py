...
#### Not needed when running with the JUPYTER DOCKER CONTAINER################################
...
def startLocalCluster(appName, partitions=4):
        ...
        .config("spark.executor.extraJavaOptions",
                "-Dsasl.jaas.config=org.apache.kafka.common.security.plain.PlainLoginModule required username=RHUIVNZYHMOODAKC password=/bkAQpKgCWjkPfTgxRY973VOhKf+MmwFulZLrAdrwdlXUTta0AUvNjo/8U57R8/w; -Dsasl.mechanism=PLAIN") \
        .master("local[*]"))
        spark = builder.getOrCreate()
        return spark
        # These are the packages that are needed for the sparksession to work with kafka and sqlserver
        # #### Not needed when running with the JUPYTER DOCKER CONTAINER################################
        # extra_packages = ["org.apache.spark:spark-sql-kafka-0-10_2.13:4.0.0", "org.postgresql:postgresql:42.7.7",
        #                          "org.elasticsearch:elasticsearch-spark-30_2.13:9.1.2"]
        #
